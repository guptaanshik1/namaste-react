...
const RestaurantMenu = () => {
  ...
  const [filteredRestaurantsMenu, setFilteredRestaurantsMenu] = useState([]);
  ...
  console.log("filteredRestaurantsMenu: ", filteredRestaurantsMenu);
